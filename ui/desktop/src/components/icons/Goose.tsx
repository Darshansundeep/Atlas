...
//
// Renders the Atlas mark (was: Goose bird SVG). Backed by the icon PNG produced // brand-allow: doc comment
// by tools/scripts/build-icons.py — drop a new logo there and rerun the script
// to update every UI surface that imports this component.
...
export function Goose({ className = '' }) { // brand-allow: internal component identifier (renaming would touch all import sites)
  return (
    <img
      src={atlasMark}
      alt="Atlas" // brand-allow: alt text identifies the brand
      width={24}
      height={24}
      className={className}
